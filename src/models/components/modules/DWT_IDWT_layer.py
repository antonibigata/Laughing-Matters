...
from src.models.components.modules.DWT_IDWT_Functions import (
    DWTFunction_1D,
    IDWTFunction_1D,
    DWTFunction_2D_tiny,
    DWTFunction_2D,
...
class DWT_2D_tiny(Module):
    ...
    def get_matrix(self):
        ...
        for i in range(L1 - L):
            ...
            index += 2
        matrix_g_0 = matrix_g[
            0 : (self.input_height - math.floor(self.input_height / 2)), 0 : (self.input_height + self.band_length - 2)
        ]
        matrix_g_1 = matrix_g[
            0 : (self.input_width - math.floor(self.input_width / 2)), 0 : (self.input_width + self.band_length - 2)
        ]
    ...
    def forward(self, input):
        ...
        return DWTFunction_2D_tiny.apply(
            input, self.matrix_low_0, self.matrix_low_1, self.matrix_high_0, self.matrix_high_1
        )
...
class IDWT_2D(Module):
    ...
    def forward(self, LL, LH, HL, HH):
        ...
        return IDWTFunction_2D.apply(
            LL, LH, HL, HH, self.matrix_low_0, self.matrix_low_1, self.matrix_high_0, self.matrix_high_1
        )
...
class DWT_3D(Module):
    ...
    def get_matrix(self):
        ...
        matrix_g_2 = matrix_g[
            0 : (self.input_depth - math.floor(self.input_depth / 2)), 0 : (self.input_depth + self.band_length - 2)
        ]
